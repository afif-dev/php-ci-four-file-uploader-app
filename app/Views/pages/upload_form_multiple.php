...
if (isset($success)): ?>
  <article class="message is-success">
    ...
    <?php foreach ($success as $key => $data): ?>
      <div><pre style="background: #effaf5"><?=  print_r($data,1) ?></pre></div>
    <?php endforeach; ?>
    </div>
  </article>
<?php endif; ?>
...
<div class="card">
    ...
    <div class="card-content">
      <?= form_open_multipart('upload/img', ["id"=>"multiple-upload", "class"=>"file-uploader"]) ?>
  ...
  <div class="card">
    ...
    <div class="card-content">
      <?= form_open_multipart('upload/pdf', ["id"=>"multiple-upload", "class"=>"file-uploader"]) ?>
        <input class="input is-normal mb-3" type="file" name="file[]" multiple />
